...
<body>
	...
	<div class="board_mainbox">
		<div class="insert_form">
			<input type="text" id="nickname" value="${param.nickname}님" readonly="readonly">
			<div class="img_box">
				<img id="uploadImage">
			</div>
		...
		<div class="insert_form2">
			...
			<h3 align="center">어디서 추억을 남기셨나요?</h3>
			<div class="brand_box">
				...
				<button type="button" id="b3" class="brand_btn" value="${brand[3].brand_num}"> 
					<img src="resources/img/partners_logo03.png" width="70px" >
				</button> 
				</div>
			<div class="brand_box">
				<button type="button" id="b4" class="brand_btn" value="${brand[2].brand_num}"> 
