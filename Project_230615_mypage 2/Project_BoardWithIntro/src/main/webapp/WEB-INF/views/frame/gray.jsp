...
<html>
	...
	<body>
			...
			<nav>
				<div class="container" align="center">
					<div class="common" onclick="location.href='intro.do'">
						<img src="resources/img2/banner_icon01.png" width="100px">
						<div class="hov_txt">
							<p>소개</p>
						</div>
					</div>
					...
					<div class="common">
						<img src="resources/img2/banner_icon02.png" width="100px">
						<div class="hov_txt">
							<p>위치</p>
						</div>	
					</div>
					...
					<div class="common" onclick="location.href='life.do'">
						<img src="resources/img2/banner_icon04.png" width="100px">
						<div class="hov_txt">
							<p>프레임</p>
						</div>
					</div>
					...
					<div class="abm common" onclick="location.href='board.do'">
						<img src="resources/img2/banner_icon05.png" width="100px">
						<div class="hov_txt">
							<p>앨범</p>
						</div>
					</div>
		...
		<div class="btn" align="center">
			...
			<button type="button" id="b4" onclick="location.href='gray.do'"> <img src="resources/img2/partners_logo03.png"> </button>
			<button type="button" id="b5" onclick="location.href='matic.do'"> <img src="resources/img2/9cca6783613b7.png" width="200px"> </button>
		</div>
		
		<div class="frame">
			<div class="image">
				 <img src="resources/img2/gray_f1.png" width="450px">
				 	<div class="img_txt">
				 		<p align="center">
				 		6000원<br>
				 		2023년 6월 1일~6월 30일
			...
			<div class="image">
				 <img src="resources/img2/gray_f2.png" height="660px">
				 	<div class="img_txt">
				 		<p align="center">
				 		6000원<br>
				 		2023년 6월 1일~6월 30일
...
<!-- 			<div class="image">
				<img src="resources/img2/gray_f3.png" width="400px">
					<div class="img_txt">
						<p align="center">
						5000원<br>
						2023년 6월 1일~6월 30일
			...
			<div class="image">
				<img src="resources/img2/gray_f4.png" width="800px">
					<div class="img_txt">
						<p align="center">
						6000원<br>
