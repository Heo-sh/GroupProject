...
$(document).ready(function(){
	...
	let windowHight = $(window).outerHeight(true);
	
	$('.section_top').css("margin-top", headHight/2 );
	$('.section').css("height", windowHight - headHight );
	
	// 좌측 이벤트 박스 슬라이드 관련 버튼
