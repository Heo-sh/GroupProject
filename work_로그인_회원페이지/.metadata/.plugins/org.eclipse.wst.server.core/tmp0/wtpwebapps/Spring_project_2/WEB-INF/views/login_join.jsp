		...
		<script type="text/javascript">
			...
			function send() {
				...
				if (nickname == "") {
					...
					document.getElementById("nick_f").innerHTML="별명을 입력해주세요";
					document.getElementById("nick_f").style.color = '#DF0000';
					return;
				}
		  ...
		  <div class="login-html">
		    ...
		    <form name="l">
		      <div class="sign-in-htm">
		        ...
		        <div class="hr"></div>
		        <div class="group">
		          <input class="button" id="signin" value="로그인" onclick="login()">
		        </div>		        
		        <!-- <div class="foot-lnk">
		     ...
		     <form name="m">
		      <div class="sign-up-htm">
		        ...
		        <div class="group">
		          <label for="pass" class="label">별명 &#42;</label>
