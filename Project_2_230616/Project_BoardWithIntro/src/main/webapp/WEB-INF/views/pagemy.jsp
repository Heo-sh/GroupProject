...
<html>
	<head>
	    ...
	    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/down/bootstrap.min.css">
	    <link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/down/fontawsom-all.min.css">
	    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/down/style.css">
	</head>
