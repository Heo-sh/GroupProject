...
<body>
	...
	<div class="board_mainbox">
		...
		<div class="insert_form">
			<input type="text" id="nickname" value="${param.nickname}">
			<div class="img_box">
				<img id="uploadImage">
			</div>
			<div class="upload_box">
				<input class="upload_name" value="파일 선택" disabled="disabled">
			...
			<div class="brand_box">
				<button class="brand_btn" value="${brand[0].brand_num}">${brand[0].brand_name}</button> 
				<button class="brand_btn" value="${brand[1].brand_num}">${brand[1].brand_name}</button> 
				<button class="brand_btn" value="${brand[2].brand_num}">${brand[2].brand_name}</button> 
			</div>
			<div class="brand_box">
				<button class="brand_btn" value="${brand[3].brand_num}">${brand[3].brand_name}</button> 
				<button class="brand_btn" value="${brand[4].brand_num}">${brand[4].brand_name}</button> 
			</div>
			<input type="hidden" id="brand_num" value="null">
			<div class="content_box">
				<input type="hidden" id="member_idx" value="${param.member_idx}">
				<textarea rows="5" cols="10" name="content" id="content"></textarea>
			</div>
			<div class="btn_box">
				<input type="button" value="등록" id="uploadbtn"> <input
					type="button" onclick="location.href='board.do'" value="취소"
					class="cancle_btn">
			</div>
		</div>
	</div>
