...
<html>
	...
	<body>
		...
		<div class="container">
			<div class="c1">
				<img id="icon" src="resources/img/map.png" width="100px" height="100px">
			...
			<div class="c2">
				<img id="icon" src="resources/img/photo_frame.png" width="100px">
			...
			<div class="c3">
				<img id="icon" src="resources/img/share.png" width="100px">
