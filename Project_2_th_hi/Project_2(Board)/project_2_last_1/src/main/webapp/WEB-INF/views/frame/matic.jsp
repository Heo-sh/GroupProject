...
<html>
	<head>
		...
		<style>
			...
			#b5{box-shadow: 0px 0px 20px #ee1d27;}
...
/* 			.image{
	...
	<body style="background-color: #efeeee;">
		...
		<div class="btn" align="center">
			...
			<button type="button" id="b2" onclick="location.href='ism.do'"> <img src="resources/img/frame_img/9c700cae91a0d.png" width="200px" style="background-color: black"></button>
			...
			<button type="button" id="b4" onclick="location.href='gray.do'"> <img src="resources/img/frame_img/photogrey_logo.png" width="200px" style="background-color: black"> </button>
		...
		<div class="frame">
			<div class="image">
				 ...
				 <img src="resources/img/frame_img/matic_f1.png" width="450px">
			</div>
			<div class="image">
			 	<div class="img_txt">
			 		<p align="center">
				 ...
				 <img src="resources/img/frame_img/matic_f2.png" width="450px">
			</div>
			<div class="image">
				<div class="img_txt">
					<p align="center">
				...
				<img src="resources/img/frame_img/matic_f3.png" width="450px">
			</div>
			<div class="image">
				<div class="img_txt">
					<p align="center">
				...
				<img src="resources/img/frame_img/matic_f4.png" width="450px">
			</div>
		</div>	
	</body>
</html>