...
.common{
   ...
   border-radius: 35%; 
   border: #fff; 
   box-shadow: -10px -10px 20px rgba(250,251,255,0.7), 6px 6px 16px rgba(209,205,199,1.7); 
   border: none; 
   outline: none; 
   cursor: pointer; 
   overflow: hidden;
...
.container{
   ...
   display: flex;   
	...
	<body style="overflow-y: scroll; background-color: #efeeee;">
	<header>
		<nav>
