			...
			<div class="banner_con section_top">
				...
				<div class="floor_box">
					<div class="bc_floor floor2">
						<button class="bn_icon" onclick="location.href='no_name'">
				...
				<div class="floor_box">
					<div class="bc_floor floor3">
						...
						<form name="f" id="nickname">
							...
							<input type="hidden" name="idx" value="${email.member_idx}">
						</form>
			...
			<div class="section">
						...
						<div class="swiper reviewSwiper">
							<c:forEach var="board_photo" items="${list}">
								<div class="swiper-slide">
									<div class="board" onclick="location.href='board.view?member_idx=${board_photo.member_idx}&photo_name=${board_photo.photo_name}'" style="width: 200px; height: 300px; border: 1px solid black">
										<input type="hidden" value="${board_photo.member_idx}" readonly="readonly">
										<input type="hidden" value="${board_photo.brand_num}" readonly="readonly">
				...
				<div class="partners">
					...
					<ul class="partners_list">
						<li><a href="https://lifefourcuts.com/"><img src="resources/img/partners_logo01.png"
							alt="인생네컷 로고"></a></li>
