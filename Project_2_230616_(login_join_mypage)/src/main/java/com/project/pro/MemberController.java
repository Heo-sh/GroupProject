...
//		model.addAttribute("list", list);
		...
		List<Board_PhotoVO> list = board_photo_dao.selectMylist(member_idx);
	...
	public String member_delete() {
		...
		comment_dao.delete(member_idx);
		board_dao.delete(member_idx);
		proPhoto_dao.delete(member_idx);
...
//		int member_idx = vo.getMember_idx();
//		
//		List<Board_PhotoVO> vo_list = board_photo_dao.selectMylist(member_idx);
//		
